...
SHOULDER_CONFIG = AppConfig(
    ...
    pathology_items=[
        ...
        ("superior_labral_tear",             "Superior Labral Tear",               ["Yes", "No"]),
        ("anteroinferior_labral_tear",       "Anteroinferior Labral Tear",         ["Yes", "No"]),
        ("biceps_tendon_tear",               "Biceps Tendon Tear",                 ["Yes", "No"]),
        ("articular_cartilage_defect",       "Articular Cartilage Defect",         ["None", "Partial Thickness", "Full Thickness"]),
        ("hill_sachs_deformity",             "Hill-Sachs Deformity",               ["Yes", "No"]),
        ("bankart_fracture",                 "Bankart Fracture",                   ["Yes", "No"]),
        ("subacromial_bursitis",             "Subacromial Bursitis",               ["Yes", "No"]),
        ("ac_oa",                            "AC Osteoarthritis",                  ["Yes", "No"]),
    ],
)
