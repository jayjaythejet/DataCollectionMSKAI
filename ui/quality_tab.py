...
class QualityTab(ctk.CTkFrame):
    def __init__(self, parent, on_change_callback=None, on_next_tab=None,
        ...
        self._items = items or QUALITY_ITEMS
        self.palette = palette or LIGHT
        self._vars = {}
        self._buttons = {}
        self._themed_labels = []   # list of (widget, palette_key)
        self._next_btn = None
        self._build()
    ...
    def _build(self):
        ...
        self._themed_label(
            self._scroll, "Image Quality Assessment", "TAB_TEXT_HEADER",
            font=ctk.CTkFont(size=15, weight="bold"),
        ).grid(row=0, column=0, columnspan=6, pady=(12, 2), padx=16, sticky="w")

        self._themed_label(
            self._scroll,
            "1 = Very Bad / Severe artifacts     5 = Very Good / No artifacts",
